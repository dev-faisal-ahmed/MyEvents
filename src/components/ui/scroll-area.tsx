...
type TScrollAreaProps = React.ComponentProps<typeof ScrollAreaPrimitive.Root> & { disableScrollbar?: boolean; fixedLayout?: boolean };

function ScrollArea({ className, children, disableScrollbar, fixedLayout, ...props }: TScrollAreaProps) {
  return (
